...
const MarketCard: FC<Props> = ({ task, index, coverBadge }) => {
  ...
  return (
    <div
      ...
      className="rounded-3.5 overflow-hidden cursor-pointer bg-white border border-solid border-[#e8e3dc] transition-all duration-250 hover:-translate-y-1 hover:shadow-lg hover:border-[#d4513b]"
