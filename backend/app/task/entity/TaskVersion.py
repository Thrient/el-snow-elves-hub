...
class TaskVersion(Base):
    ...
    file_meta_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("file_metas.id", ondelete="CASCADE"), nullable=True
    )
    ...
    file_meta = relationship("FileMeta", foreign_keys=[file_meta_id], lazy="selectin")
